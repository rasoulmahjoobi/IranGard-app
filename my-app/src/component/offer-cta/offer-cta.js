  ...
  return (
    <div className="offer-cta-container">
      ...
      <p className="offer-text">
        ...
        <span className="text-blue">Abr Forest</span> offers a
        once-in-a-lifetime journey where mist, mountains, and untouched nature
        come together in perfect harmony. Leave your details below and let us
        guide you into this hidden paradise.
      </p>
